    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Change Motor Report</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item">Report</li>
                <li class="breadcrumb-item active">Change Motor Report</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Change Motor Report Table</h3>
                </div>
                <div class="card-body">
                  <div class="row">
                    ...
                    <label class="cntrbtn"><button class="btn btn-info" id="btn-report-changemotor-search">Search</button></label>
                  </div>
                  <table class="table table-responsive table-hover table-bordered text-nowrap m-0" id="changemotor-masterlist-table" width="100%">
                    <thead>
                      <tr>
