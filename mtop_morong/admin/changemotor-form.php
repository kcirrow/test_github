...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Change Motor <p style="display: inline-block;" id="displayStatus"></p>
              </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Change Motor</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card-header bg-success">
                      <h3 class="card-title">New Motor/Franchise Information</h3>
                      <div class="card-tools">
                      </div>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6">
                          <h5>Motor Information</h5>
                          <p>Motor ID: <label id="form-motorid-new"></label></p>
                          <p>TODA - Body #: <label id="form-motortoda-new"></label></p>
                          <p>Make: <label id="form-motormake-new"></label></p>
                          <p>Chassis #: <label id="form-motorchassis-new"></label></p>
                          <p>Engine #: <label id="form-motorengine-new"></label></p>
                          <p>Plate #: <label id="form-motorplate-new"></label></p>
                          <p>Sticker Exp. Date #: <label id="form-motorstickerexpdate-new"></label></p>
                          <p>Franchise Exp. Date #: <label id="form-franchiseexpdate-new"></label></p>
                        </div>
                        <div class="col-md-6  ">
                          <h5>Franchise Information</h5>
                          <p>Franchise #: <label id="form-motormtop-new"></label></p>
                          <p>Last Renew: <label id="form-lastrenew-new"></label></p>
                          <p>TR-CODE: <label id="form-trcode-new"></label></p>
                          <p>Plate Color: <label id="form-motorplatecolor-new"></label></p>
                          <div class="row">
                            <div class="col-md-6">
                              <p>
                                Application Type:
                                <label id="form-applicationtype">CHANGE MOTOR</label>
                              </p>
                              </p>
                            </div>
                            <div class="col-md-6">
              ...
              <div class="row">
                  <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form action="#" method="POST" autocomplete="off" id="repapplication-form">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <button class="btn btn-primary btn-block" id="btn-submit-franchise">Submit Application</button>
  ...
  <script type="text/javascript" src="js/changemotor-form.js"></script>
