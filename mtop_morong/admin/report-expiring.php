    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Expiring Franchise</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item">Report</li>
                <li class="breadcrumb-item active">Expiring Franchise</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Expiring Franchise Table</h3>
                </div>
                <div class="card-body">
                  <div class="row">
                    ...
                    <label style="padding-right: 5px">Date: <input type="text" class="form-control" id="datefrom"></label>
                    <label calss="cntrbtn"><button class="btn btn-info" id="btn-report-expiring-franchise-search">Search</button></label>
                  </div>
                  <table class="table table-hover table-bordered text-nowrap m-0" id="expiring-franchise-table" width="100%">
                    <thead>
                      <tr>
                        <th>TODA</th>
                        <th>Operator Name</th>
