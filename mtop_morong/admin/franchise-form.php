...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Tricycle Franchise <p style="display: inline-block;" id="displayStatus"></p>
              </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                        ...
                        <div class="col-md-6  ">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <p>
                                Application Type:
                                <select class="form-control" id="form-applicationtype">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form action="#" method="POST" autocomplete="off" id="repapplication-form">
                            <table class="table table-bordered table-hover table-striped nowrap projects" id="req-application-datatable" width="100%">
                              <thead>
                                <tr>
  ...
  <script type="text/javascript" src="js/franchise-form.js"></script>
