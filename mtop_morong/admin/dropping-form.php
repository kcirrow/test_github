...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Dropping <p style="display: inline-block;" id="displayStatus"></p>
              </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Dropping</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Motor/Franchise Information <p style="display: inline-block;" id="displayFranStatus"></p>
                      </h3>
                      <div class="card-tools">
                      </div>
                    </div>
                        ...
                        <div class="col-md-12">
                          <div class="row">
                            <div class="col-md-6">
                              <p>
                                Application Type:
                                <label id="form-applicationtype">DROPPING</label>
                              </p>
                              </p>
                            </div>
                            <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <p>Dropping Reason:</p>
                              <input type="text" class="form-control" name="form-reason" id="form-reason">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
  ...
  <script type="text/javascript" src="js/dropping-form.js"></script>
