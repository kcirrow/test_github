              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <label class="cntrbtn"><button class="btn btn-info" id="btn-report-collection-search">Search</button></label>
                  </div>
                  <table class="table table-hover table-bordered text-nowrap m-0" id="collection-table" width="100%">
                    <thead>
                      <tr>
                        <th>TR-CODE</th>
                        <th>Name</th>
