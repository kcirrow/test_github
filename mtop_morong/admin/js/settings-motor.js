...
$("#settingsmotortable tbody").on("click", "#btn-settings-motor-view",function () {
  var d = settingsmotor.row($(this).closest('tr')).data();
  $.ajax({
...
$("#settingsmotortable tbody").on("click", "#btn-settings-motor-delete", function () {
  var d = settingsmotor.row($(this).closest("tr")).data();
    Swal.fire({
