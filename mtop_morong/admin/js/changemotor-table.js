$(document).ready(function () {
  $("#changemotortable").on("click", "#btn-view", function () {
    var d = changemotortable.row($(this).closest("tr")).data();
    window.location.href =
      baseurl + "/admin/changemotor-form.php?trcode=" + d.trcode;
  });
  var cmselection = "";
  $("#btn-apply-changemotor").click(function () {
  ...
  $("#cmselectiontable tbody").on("dblclick", "tr", function () {
    ...
    window.location.href =
      baseurl + "/admin/changemotor-form.php?motor=" + d.motorpin;
  });
  ...
  $("#changemotortable").on("click", "#btn-cancel", function () {
    var d = changemotortable.row($(this).closest("tr")).data();
    Swal.fire({
...
$("#cmselectiontable tbody").on("click", "tr", function () {
  $("#cmselectiontable tbody tr").removeClass("selected");
  $(this).addClass("selected");
});

$("#btn-cmselection-select").click(function () {
    var d = cmselection.row($("#cmselectiontable .selected").closest('tr')).data();
    window.location.href =
      baseurl + "/admin/changeownership-form.php?motor=" + d.motorpin;
});
...
// Assessment Section
//=============================================================================================================
changemotortable.on("click", "#btn-changemotor-assessment", function () {
  var d = changemotortable.row($(this).closest("tr")).data();
  assyes = changemotortable;
...
changemotortable.on("click", "#btn-changemotor-inspection", function () {
  var d = changemotortable.row($(this).closest("tr")).data();
  state = d;
  $.ajax({
...
$("#btn-inspect-save").click(function () {
  ...
  data1.append("opcode", state.newopcode);
...
// Releasing Section
//=============================================================================================================
changemotortable.on("click", "#btn-changemotor-release", function () {
  var d = changemotortable.row($(this).closest("tr")).data();
  state = d;
  if (d.target_path == "") {
...
// $("#btn-operator-printid").click(function () {
//   window.open(baseurl + "/config/morong_id/morong_mtop_idd.php?trcode="+state.trcode+"&app="+state.appl_status+"&approve="+$("#relapprove").val());
// });
