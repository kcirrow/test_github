$(document).ready(function () {
  $("#changedrivertable").on("click", "#btn-view", function () {
    var d = changedrivertable.row($(this).closest("tr")).data();
    window.location.href =
      baseurl + "/admin/changedriver-form.php?trcode=" + d.trcode;
  });
  var cmselection = "";
  $("#btn-apply-changedriver").click(function () {
  ...
  $("#cmselectiontable tbody").on("dblclick", "tr", function () {
    ...
    window.location.href =
      baseurl + "/admin/changedriver-form.php?motor=" + d.motorpin;
  });
  ...
  $("#changedriver-table").addClass("active");

  $("#changedrivertable").on("click", "#btn-cancel", function () {
    var d = changedrivertable.row($(this).closest("tr")).data();
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "../config/includes.php?var=cancelchangedriver",
              method: "POST",
              data: {
                trcode: d.trcode,
                reason: $("#reason").val(),
...
$("#btn-cmselection-select").click(function () {
    ...
    window.location.href =
      "<?php echo $class->base_url(); ?>" + "/admin/changedriver-form.php?motor=" + d.motorpin;
});

//=============================================================================================================
// Assessment Section
//=============================================================================================================
changedrivertable.on(
  "click",
  "#btn-changedriver-assessment",
  function () {
    var d = changedrivertable.row($(this).closest("tr")).data();
    assyes = changedrivertable;
...
// Releasing Section
//=============================================================================================================
changedrivertable.on("click", "#btn-changedriver-release", function () {
  var d = changedrivertable.row($(this).closest("tr")).data();
  state = d;
  if (d.target_path == "") {
