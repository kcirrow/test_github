...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Change Ownership <p style="display: inline-block;" id="displayStatus"></p>
              </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                            ...
                            <div class="col-md-12">
                              <div class="row">
                                <div class="col-md-6">
                                  <p>
                                    Application Type:
                                    <label id="form-applicationtype">CHANGE OWNERSHIP</label>
                                  </p>
                                  </p>
                                </div>
                                <div class="col-md-6">
  ...
  <script type="text/javascript" src="js/changeownership-form.js"></script>
