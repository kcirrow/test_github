...
<style>
  .waitmodal {
    ...
    background: rgba(255, 255, 255) url("/bpl/source/main/img/load.gif") center no-repeat;
  }
...
<body class="hold-transition login-page">
  ...
  <script src="/bpladmin/source/main1/plugins/jquery-ui/jquery-ui.min.js"></script>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $("#btn-req").click(function() {
        $.ajax({
          url: "/bpladmin/login/sendEmailForgot",
          method: "POST",
          data: {
          ...
          success: function(e) {
            Swal.fire({
              ...
              if (result.isConfirmed) {
                if (e.bool) {
                  location.href = "/bpladmin/login/verify?email=" + $("#recovery-email").val();
                } else {
                }
              }
            })
