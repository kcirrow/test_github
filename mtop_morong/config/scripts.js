...
function statusButton(status, type) {
  switch (type) {
    ...
    case "changemotor"://case "changemotor":
      if (status == "FOR ASSESSMENT") {
    ...
    case "changedriver":
      if (status == "FOR ASSESSMENT") {
        return "<button class='btn btn-primary' id='btn-view' data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-folder-open'></i></button> <button class='btn btn-warning' id='btn-changedriver-inspection' data-toggle='tooltip' data-placement='top' title='Inspection'><i class='fa fa-eye'></i></button> <button class='btn btn-info' id='btn-changedriver-assessment' data-toggle='tooltip' data-placement='top' title='Assessment'><i class='fa fa-book-open'></i></button> <button class='btn btn-danger' id='btn-cancel' data-toggle='tooltip' data-placement='top' title='Cancel'><i class='fa fa-times'></i></button>";
      } else if (status == "FOR INSPECTION" || status == "DENIED") {
        return "<button class='btn btn-primary' id='btn-view' data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-folder-open'></i></button> <button class='btn btn-warning' id='btn-changedriver-inspection' data-toggle='tooltip' data-placement='top' title='Inspection'><i class='fa fa-eye'></i></button> <button class='btn btn-danger' id='btn-cancel' data-toggle='tooltip' data-placement='top' title='Cancel'><i class='fa fa-times'></i></button>";
      } else if (status == "FOR PAYMENT") {
        return "<button class='btn btn-primary' id='btn-view' data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-folder-open'></i></button> <button class='btn btn-warning' id='btn-changedriver-inspection' data-toggle='tooltip' data-placement='top' title='Inspection'><i class='fa fa-eye'></i></button> <button class='btn btn-info' id='btn-changedriver-assessment' data-toggle='tooltip' data-placement='top' title='Assessment'><i class='fa fa-book-open'></i></button> <button class='btn btn-danger' id='btn-cancel' data-toggle='tooltip' data-placement='top' title='Cancel'><i class='fa fa-times'></i></button>";
      } else if (status == "FOR RELEASING" || status == "RELEASED") {
        return "<button class='btn btn-primary' id='btn-view' data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-folder-open'></i></button> <button class='btn btn-warning' id='btn-changedriver-inspection' data-toggle='tooltip' data-placement='top' title='Inspection'><i class='fa fa-eye'></i></button> <button class='btn btn-info' id='btn-changedriver-release' data-toggle='tooltip' data-placement='top' title='Release'><i class='fa fa-check'></i></button> <button class='btn btn-danger' id='btn-cancel' data-toggle='tooltip' data-placement='top' title='Cancel'><i class='fa fa-times'></i></button>";
      }
      break;
  ...
  columns: [
    {
      data: function (e) {
        ...
        } else if (e.appl_status == "CHANGE DRIVER") {
          return (
            "<a href='"+baseurl+"/admin/changedriver-table.php?trcode=" +
            e.trcode +
            "'>" +
            e.trcode +
            "</a>"
  ...
  columns: [
    {
      ...
      //abcd
            data: function (e) {
                return "<button class='btn btn-primary' id='btn-view' data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-folder-open'></i></button> <button class='btn btn-warning' id='btn-changedriver-inspection' data-toggle='tooltip' data-placement='top' title='Inspection'><i class='fa fa-eye'></i></button> <button class='btn btn-info' id='btn-changedriver-assessment' data-toggle='tooltip' data-placement='top' title='Assessment'><i class='fa fa-book-open'></i></button> <button class='btn btn-info' id='btn-changedriver-release' data-toggle='tooltip' data-placement='top' title='Release'><i class='fa fa-check'></i></button>  <button class='btn btn-danger' id='btn-cancel' data-toggle='tooltip' data-placement='top' title='Cancel'><i class='fa fa-times'></i></button>";
            }
      },
    { data: "trcode" },
    {
...
$("#btn-status-edit").click(function () {
  var d = settingsstatus.row(".selected").data();
  $.ajax({
    url: "../config/includes.php?var=updatestatus",
    method: "POST",
    data: $("#status-form-submit").serialize() + "&sid=" + state.ID,
    dataType: "JSON",
    success: function (e) {
      if (e.result) {
        Swal.fire("Done!", e.msg, "success");
